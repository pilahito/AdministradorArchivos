...
## v1.1.0-pro — Windows + Linux desktop Tauri 2 — 2026-09-06

### Registros de mejora

| Area | Mejora |
|------|--------|
| Desktop Win+Linux | App Tauri 2 en `app-desktop/` (Rust + Vite + xterm.js) |
...
| Empaquetado | Windows NSIS/MSI; Linux deb + AppImage; CI matrix desktop.yml |
